**Note: This is a fork of `https://github.com/DylanVann/react-native-fast-image`, with the AndroidX support, but it doesn't crash Xcode (react-native <= 0.59 compatible).**
