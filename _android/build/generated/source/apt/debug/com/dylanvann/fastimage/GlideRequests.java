...
public class GlideRequests extends RequestManager {
  ...
  @Override
  @NonNull
  public GlideRequests applyDefaultRequestOptions(@androidx.annotation.NonNull RequestOptions options) {
    return (GlideRequests) super.applyDefaultRequestOptions(options);
  }

  @Override
  @NonNull
  public GlideRequests setDefaultRequestOptions(@androidx.annotation.NonNull RequestOptions options) {
